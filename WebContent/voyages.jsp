            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    ...
                    <div>
                        ...
                        <span class="label label-primary" title="${ mapVoyages.value.theme.description }">${ mapVoyages.value.theme.nom }</span>
                        <span class="label label-primary" title="${ mapVoyages.value.theme.type.description }">${ mapVoyages.value.theme.type.nom }</span>
                    </div>
