...
<head>
    ...
    <title>Espace Administrateur - Liste des thèmes</title>
</head>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="col-md-4">
                    ...
                    <div class="panel-body">
                        <form method="post" action="<c:url value="/liste_themes"/>">
                            ...
                            <div class="control-group form-group">
                                <div class="controls">
                                    ...
                                    <textarea rows="10" cols="100" class="form-control" id="description" name="description" style="resize: vertical;"><c:out value="${ theme.description }"/></textarea>
                                    ...
                                    <div>
                                        <select class="form-control" name="listeTypes" id="listeTypes">
                                            <c:forEach items="${ sessionScope.types }" var="mapTypes">
                                                <option value="${ mapTypes.key }" ${ mapTypes.key eq theme.type.id ? 'selected' : '' }>${ mapTypes.value.nom }</option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                </div>
            ...
            <div class="col-md-7">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <strong>Liste des thèmes</strong>
                    </div>
                    <c:choose>
                        <c:when test="${ empty sessionScope.themes }">
                            <p class="erreur">Aucun thème enregistré.</p>
                        </c:when>
                        <c:otherwise>
