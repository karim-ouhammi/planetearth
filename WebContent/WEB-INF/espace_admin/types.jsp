...
<head>
    ...
    <title>Espace Administrateur - Liste des types</title>
</head>
                ...
                <div class="col-md-4">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <strong>Ajouter un type de voyages</strong>
                        </div>
                    <div class="panel-body">
                        <form method="post" action="<c:url value="/liste_types"/>">
                            ...
                            <div class="control-group form-group">
                                <div class="controls">
                                    ...
                                    <textarea rows="10" cols="100" class="form-control" id="description" name="description" style="resize: vertical;"><c:out value="${ type.description }"/></textarea>
